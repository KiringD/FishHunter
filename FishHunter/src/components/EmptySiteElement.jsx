...
class EmptySiteElement extends React.Component {
  siteAdd = {}
  constructor(props) {
    super(props)
    this.state = {
  ...
  render() {
    return (
      <div style={this.props.isSelected}>
        <div className={styles.EsiteElement} onClick={this.handleClick}>
          <div className={styles.EsiteBack}></div>
          <div className={styles.EdecBorder}>
            <svg className={styles.EsitePlus} height="50px" width="50px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              viewBox="0 0 490 490" xmlSpace="preserve">
              <g>
                <g>
                  <g>
                    <circle className={styles.EplusRound} cx="245" cy="245" r="240" fill="none" />
                    <path className={styles.EplusPlus} d="M227.8,174.1v53.7h-53.7c-9.5,0-17.2,7.7-17.2,17.2s7.7,17.2,17.2,17.2h53.7v53.7c0,9.5,7.7,17.2,17.2,17.2
          ...
          S354.2,56.2,394,96S455.7,188.7,455.7,245z"/>
            ...
            <div className={styles.EplusText}>Добавить сайт</div>
          </div>
        </div>
      </div>
...
export default EmptySiteElement
